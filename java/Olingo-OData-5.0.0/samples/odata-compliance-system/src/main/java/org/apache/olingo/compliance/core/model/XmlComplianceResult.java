...
public class XmlComplianceResult {
     ...
     * 
     * @return list of all ComplianceIssue objects
     */
     ...
     * 
     * @return list of error ComplianceIssue objects
     */
    public List<ComplianceIssue> getErrors() {
        return issues.stream()
                .filter(issue -> issue.getSeverity() == ComplianceIssue.Severity.ERROR)
     ...
     * 
     * @return list of warning ComplianceIssue objects
     */
    public List<ComplianceIssue> getWarnings() {
        return issues.stream()
                .filter(issue -> issue.getSeverity() == ComplianceIssue.Severity.WARNING)
                .collect(Collectors.toList());
    }
     ...
     * @deprecated Use getErrors() and ComplianceIssue.getMessage() for structured access
     */
    @Deprecated
     ...
     * @deprecated Use getWarnings() and ComplianceIssue.getMessage() for structured access
     */
    @Deprecated
     ...
     */
    public List<ComplianceIssue> getIssuesOfType(ComplianceErrorType errorType) {
        return issues.stream()
     ...
     */
    public List<ComplianceIssue> getErrorsOfType(ComplianceErrorType errorType) {
        return getErrors().stream()
