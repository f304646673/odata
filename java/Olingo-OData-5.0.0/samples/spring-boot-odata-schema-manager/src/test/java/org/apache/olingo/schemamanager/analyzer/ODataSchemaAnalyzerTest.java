...
class ODataSchemaAnalyzerTest {
    ...
    //     when(repository.getAllSchemas()).thenReturn(Map.of("TestService", testSchema));
    ...
    //     Map<String, Set<String>> dependencies = Map.of("Type1", Set.of("Type2"));
    //     Map<String, String> typeLocations = Map.of("Type1", "file1.xml");
    ...
    //     Set<String> directDependencies = Set.of("TestService.Address");
    //     Set<String> allDependencies = Set.of("TestService.Address", "TestService.Country");
    //     Set<String> dependents = Set.of("TestService.Order");
    ...
    //     ODataXmlLoader.LoadResult loadResult = new ODataXmlLoader.LoadResult(
    //         1, 0, new ArrayList<>(), Arrays.asList("file1.xml")
    //     );
        
    //     when(xmlLoader.loadFromDirectory(directoryPath)).thenReturn(loadResult);
    //     when(repository.getAllSchemas()).thenReturn(Map.of("TestService", schemaWithMissingDep));
    ...
    //     when(xmlLoader.loadFromDirectory(directoryPath)).thenReturn(loadResult);
    //     when(repository.getAllSchemas()).thenReturn(Map.of("TestService", circularSchema));
    ...
    //     Map<String, CsdlSchema> multipleSchemas = Map.of(
    //         "TestService", testSchema,
    //         "SecondService", secondSchema
    //     );
        
    //     ODataXmlLoader.LoadResult loadResult = new ODataXmlLoader.LoadResult(
    //         2, 0, new ArrayList<>(), Arrays.asList("file1.xml", "file2.xml")
    //     );
    ...
    //     when(xmlLoader.loadFromDirectory(directoryPath)).thenReturn(loadResult);
    //     when(repository.getAllSchemas()).thenReturn(new HashMap<>());
