...
/**
 * Base processor for XML Split OData operations
 */
public abstract class BaseXmlSplitODataProcessor {
     ...
     * @return entity set
     */
    protected EdmEntitySet getEntitySet(UriInfo uriInfo) {
     ...
     */
    protected void configureResponse(ODataResponse response, SerializerResult serializerResult, ContentType responseFormat) {
     ...
     * @return context URL
     */
    protected ContextURL createEntityCollectionContextUrl(EdmEntitySet edmEntitySet) {
