 ...
 */
public class ExtendedCsdlTypeDefinition extends CsdlTypeDefinition {
    ...
    public void analyzeDependencies() {
        ...
        if (getUnderlyingType() != null) {
            String underlyingTypeNamespace = extractNamespace(getUnderlyingType());
            if (underlyingTypeNamespace != null) {
                addDependency(underlyingTypeNamespace);
            }
        }
    }
    ...
    public ExtendedCsdlTypeDefinition setUnderlyingType(String underlyingType) {
        super.setUnderlyingType(underlyingType);
        analyzeDependencies();
        return this;
    }
}
