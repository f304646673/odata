...
public class XmlBasedEdmProvider extends CsdlAbstractEdmProvider {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(XmlBasedEdmProvider.class);
    ...
    private void loadXmlMetadata() {
        try {
            LOG.info("Loading EDM metadata from XML file: {}", xmlFilePath);
            ...
            LOG.info("Successfully loaded EDM metadata from XML file");
            
        } catch (Exception e) {
            LOG.error("Failed to load XML metadata from file: {}", xmlFilePath, e);
    ...
    public CsdlEntityType getEntityType(FullQualifiedName entityTypeName) throws ODataException {
        LOG.debug("Getting entity type: {}", entityTypeName);
    ...
    public CsdlComplexType getComplexType(FullQualifiedName complexTypeName) throws ODataException {
        LOG.debug("Getting complex type: {}", complexTypeName);
    ...
    public CsdlEntitySet getEntitySet(FullQualifiedName entityContainer, String entitySetName) throws ODataException {
        LOG.debug("Getting entity set: {} in container: {}", entitySetName, entityContainer);
    ...
    public CsdlEntityContainerInfo getEntityContainerInfo(FullQualifiedName entityContainerName) throws ODataException {
        LOG.debug("Getting entity container info: {}", entityContainerName);
