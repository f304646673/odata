 ...
 */
public class ExtendedCsdlActionRefactored extends AbstractExtendedCsdlElement<CsdlAction, ExtendedCsdlActionRefactored> implements ExtendedCsdlElement {
     ...
     * 构造函数
     */
    public ExtendedCsdlActionRefactored() {
     ...
     */
    public static ExtendedCsdlActionRefactored fromCsdlAction(CsdlAction source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlActionRefactored extended = new ExtendedCsdlActionRefactored();
    ...
    public ExtendedCsdlActionRefactored setName(String name) {
    ...
    public ExtendedCsdlActionRefactored setBound(boolean isBound) {
    ...
    public ExtendedCsdlActionRefactored setEntitySetPath(String entitySetPath) {
    ...
    public ExtendedCsdlActionRefactored setParameters(List<CsdlParameter> parameters) {
    ...
    public ExtendedCsdlActionRefactored setReturnType(CsdlReturnType returnType) {
    ...
    public ExtendedCsdlActionRefactored addExtendedParameter(ExtendedCsdlParameter parameter) {
        if (parameter != null) {
    ...
    public ExtendedCsdlActionRefactored setExtendedParameters(List<ExtendedCsdlParameter> parameters) {
    ...
    public ExtendedCsdlActionRefactored setExtendedReturnType(ExtendedCsdlReturnType returnType) {
    ...
    public String toString() {
        return "ExtendedCsdlActionRefactored{" +
                "name='" + getName() + '\'' +
                ", namespace='" + namespace + '\'' +
                ", isBound=" + isBound() +
