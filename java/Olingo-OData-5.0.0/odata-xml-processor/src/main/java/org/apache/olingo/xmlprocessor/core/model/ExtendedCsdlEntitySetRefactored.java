 ...
 */
public class ExtendedCsdlEntitySetRefactored extends AbstractExtendedCsdlElement<CsdlEntitySet, ExtendedCsdlEntitySetRefactored> implements ExtendedCsdlElement {
     ...
     * 构造函数
     */
    public ExtendedCsdlEntitySetRefactored() {
     ...
     */
    public static ExtendedCsdlEntitySetRefactored fromCsdlEntitySet(CsdlEntitySet source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlEntitySetRefactored extended = new ExtendedCsdlEntitySetRefactored();
    ...
    public ExtendedCsdlEntitySetRefactored setName(String name) {
    ...
    public ExtendedCsdlEntitySetRefactored setType(String type) {
    ...
    public ExtendedCsdlEntitySetRefactored setIncludeInServiceDocument(boolean includeInServiceDocument) {
    ...
    public ExtendedCsdlEntitySetRefactored setNavigationPropertyBindings(List<CsdlNavigationPropertyBinding> bindings) {
    ...
    public ExtendedCsdlEntitySetRefactored addExtendedNavigationPropertyBinding(ExtendedCsdlNavigationPropertyBinding binding) {
        if (binding != null) {
    ...
    public ExtendedCsdlEntitySetRefactored setExtendedNavigationPropertyBindings(List<ExtendedCsdlNavigationPropertyBinding> bindings) {
    ...
    public String toString() {
        return "ExtendedCsdlEntitySetRefactored{" +
                "name='" + getName() + '\'' +
                ", namespace='" + namespace + '\'' +
                ", type='" + getType() + '\'' +
