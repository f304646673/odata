 ...
 */
public class ExtendedCsdlFunctionRefactored extends AbstractExtendedCsdlElement<CsdlFunction, ExtendedCsdlFunctionRefactored> implements ExtendedCsdlElement {
     ...
     * 构造函数
     */
    public ExtendedCsdlFunctionRefactored() {
     ...
     */
    public static ExtendedCsdlFunctionRefactored fromCsdlFunction(CsdlFunction source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlFunctionRefactored extended = new ExtendedCsdlFunctionRefactored();
    ...
    public ExtendedCsdlFunctionRefactored setName(String name) {
    ...
    public ExtendedCsdlFunctionRefactored setBound(boolean isBound) {
    ...
    public ExtendedCsdlFunctionRefactored setComposable(boolean isComposable) {
    ...
    public ExtendedCsdlFunctionRefactored setEntitySetPath(String entitySetPath) {
    ...
    public ExtendedCsdlFunctionRefactored setParameters(List<CsdlParameter> parameters) {
    ...
    public ExtendedCsdlFunctionRefactored setReturnType(CsdlReturnType returnType) {
    ...
    public ExtendedCsdlFunctionRefactored addExtendedParameter(ExtendedCsdlParameter parameter) {
        if (parameter != null) {
    ...
    public ExtendedCsdlFunctionRefactored setExtendedParameters(List<ExtendedCsdlParameter> parameters) {
    ...
    public ExtendedCsdlFunctionRefactored setExtendedReturnType(ExtendedCsdlReturnType returnType) {
    ...
    public String toString() {
        return "ExtendedCsdlFunctionRefactored{" +
                "name='" + getName() + '\'' +
                ", namespace='" + namespace + '\'' +
                ", isBound=" + isBound() +
