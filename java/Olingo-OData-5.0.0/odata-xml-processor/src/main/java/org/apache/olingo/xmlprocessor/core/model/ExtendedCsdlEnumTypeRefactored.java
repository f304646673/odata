 ...
 */
public class ExtendedCsdlEnumTypeRefactored extends AbstractExtendedCsdlElement<CsdlEnumType, ExtendedCsdlEnumTypeRefactored> implements ExtendedCsdlElement {

    /**
     * 构造函数
     */
    public ExtendedCsdlEnumTypeRefactored() {
     ...
     */
    public static ExtendedCsdlEnumTypeRefactored fromCsdlEnumType(CsdlEnumType source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlEnumTypeRefactored extended = new ExtendedCsdlEnumTypeRefactored();
    ...
    public ExtendedCsdlEnumTypeRefactored setName(String name) {
    ...
    public ExtendedCsdlEnumTypeRefactored setUnderlyingType(String underlyingType) {
    ...
    public ExtendedCsdlEnumTypeRefactored setFlags(boolean isFlags) {
    ...
    public ExtendedCsdlEnumTypeRefactored setMembers(List<CsdlEnumMember> members) {
    ...
    public String toString() {
        return "ExtendedCsdlEnumTypeRefactored{" +
                "name='" + getName() + '\'' +
                ", namespace='" + namespace + '\'' +
