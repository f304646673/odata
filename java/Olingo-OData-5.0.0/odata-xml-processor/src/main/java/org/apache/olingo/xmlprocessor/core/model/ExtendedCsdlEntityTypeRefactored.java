 ...
 */
public class ExtendedCsdlEntityTypeRefactored extends AbstractExtendedCsdlElement<CsdlEntityType, ExtendedCsdlEntityTypeRefactored> implements ExtendedCsdlElement {
     ...
     * 构造函数
     */
    public ExtendedCsdlEntityTypeRefactored() {
     ...
     */
    public static ExtendedCsdlEntityTypeRefactored fromCsdlEntityType(CsdlEntityType source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlEntityTypeRefactored extended = new ExtendedCsdlEntityTypeRefactored();
    ...
    public ExtendedCsdlEntityTypeRefactored setName(String name) {
    ...
    public ExtendedCsdlEntityTypeRefactored setBaseType(FullQualifiedName baseType) {
        wrappedElement.setBaseType(baseType);
        return this;
    }

    public ExtendedCsdlEntityTypeRefactored setBaseType(String baseType) {
    ...
    public ExtendedCsdlEntityTypeRefactored setAbstract(boolean isAbstract) {
    ...
    public ExtendedCsdlEntityTypeRefactored setOpenType(boolean isOpenType) {
    ...
    public ExtendedCsdlEntityTypeRefactored setHasStream(boolean hasStream) {
    ...
    public ExtendedCsdlEntityTypeRefactored setKey(List<CsdlPropertyRef> key) {
     ...
     */
    public ExtendedCsdlEntityTypeRefactored addExtendedProperty(ExtendedCsdlProperty extendedProperty) {
     ...
     */
    public ExtendedCsdlEntityTypeRefactored setExtendedProperties(List<ExtendedCsdlProperty> extendedProperties) {
    ...
    @Deprecated
    public ExtendedCsdlEntityTypeRefactored setProperties(List<CsdlProperty> properties) {
     ...
     */
    public ExtendedCsdlEntityTypeRefactored addExtendedNavigationProperty(ExtendedCsdlNavigationProperty extendedNavProperty) {
     ...
     */
    public ExtendedCsdlEntityTypeRefactored setExtendedNavigationProperties(List<ExtendedCsdlNavigationProperty> extendedNavProperties) {
    ...
    @Deprecated
    public ExtendedCsdlEntityTypeRefactored setNavigationProperties(List<CsdlNavigationProperty> navigationProperties) {
    ...
    @Override
    public ExtendedCsdlEntityTypeRefactored setNamespace(String namespace) {
    ...
    public String toString() {
        return "ExtendedCsdlEntityTypeRefactored{" +
                "name='" + getName() + '\'' +
                ", namespace='" + namespace + '\'' +
