 ...
 */
public class ExtendedCsdlSchemaRefactored extends AbstractExtendedCsdlElement<CsdlSchema, ExtendedCsdlSchemaRefactored> implements ExtendedCsdlElement {
     ...
     * 构造函数
     */
    public ExtendedCsdlSchemaRefactored() {
     ...
     * 构造函数
     */
    public ExtendedCsdlSchemaRefactored(String namespace) {
        super(new CsdlSchema());
     ...
     */
    public static ExtendedCsdlSchemaRefactored fromCsdlSchema(CsdlSchema source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlSchemaRefactored extended = new ExtendedCsdlSchemaRefactored();
    ...
    @Override
    public ExtendedCsdlSchemaRefactored setNamespace(String namespace) {
    ...
    public ExtendedCsdlSchemaRefactored setAlias(String alias) {
    ...
    public ExtendedCsdlSchemaRefactored setEntityTypes(List<CsdlEntityType> entityTypes) {
    ...
    public ExtendedCsdlSchemaRefactored setComplexTypes(List<CsdlComplexType> complexTypes) {
    ...
    public ExtendedCsdlSchemaRefactored setEnumTypes(List<CsdlEnumType> enumTypes) {
    ...
    public ExtendedCsdlSchemaRefactored setActions(List<CsdlAction> actions) {
    ...
    public ExtendedCsdlSchemaRefactored setFunctions(List<CsdlFunction> functions) {
    ...
    public ExtendedCsdlSchemaRefactored setTypeDefinitions(List<CsdlTypeDefinition> typeDefinitions) {
    ...
    public ExtendedCsdlSchemaRefactored setTerms(List<CsdlTerm> terms) {
    ...
    public ExtendedCsdlSchemaRefactored setEntityContainer(CsdlEntityContainer entityContainer) {
    ...
    public ExtendedCsdlSchemaRefactored addExtendedEntityType(ExtendedCsdlEntityType entityType) {
        if (entityType != null) {
    ...
    public ExtendedCsdlSchemaRefactored addExtendedComplexType(ExtendedCsdlComplexType complexType) {
        if (complexType != null) {
    ...
    public ExtendedCsdlSchemaRefactored addExtendedAction(ExtendedCsdlAction action) {
        if (action != null) {
    ...
    public ExtendedCsdlSchemaRefactored addExtendedFunction(ExtendedCsdlFunction function) {
        if (function != null) {
    ...
    public ExtendedCsdlSchemaRefactored setExtendedEntityContainer(ExtendedCsdlEntityContainer container) {
    ...
    public ExtendedCsdlSchemaRefactored setSourcePath(String sourcePath) {
    ...
    public ExtendedCsdlSchemaRefactored addReferencedNamespace(String namespace) {
    ...
    public String toString() {
        return "ExtendedCsdlSchemaRefactored{" +
