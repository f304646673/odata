 ...
 */
public class ExtendedCsdlNavigationPropertyBindingRefactored extends AbstractExtendedCsdlElement<CsdlNavigationPropertyBinding, ExtendedCsdlNavigationPropertyBindingRefactored> implements ExtendedCsdlElement {

    /**
     * 构造函数
     */
    public ExtendedCsdlNavigationPropertyBindingRefactored() {
     ...
     */
    public static ExtendedCsdlNavigationPropertyBindingRefactored fromCsdlNavigationPropertyBinding(CsdlNavigationPropertyBinding source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlNavigationPropertyBindingRefactored extended = new ExtendedCsdlNavigationPropertyBindingRefactored();
    ...
    public ExtendedCsdlNavigationPropertyBindingRefactored setPath(String path) {
    ...
    public ExtendedCsdlNavigationPropertyBindingRefactored setTarget(String target) {
    ...
    public String toString() {
        return "ExtendedCsdlNavigationPropertyBindingRefactored{" +
                "path='" + getPath() + '\'' +
                ", target='" + getTarget() + '\'' +
                ", namespace='" + namespace + '\'' +
                '}';
