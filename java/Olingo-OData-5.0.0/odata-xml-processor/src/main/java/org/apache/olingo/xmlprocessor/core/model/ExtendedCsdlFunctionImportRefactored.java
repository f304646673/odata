 ...
 */
public class ExtendedCsdlFunctionImportRefactored extends AbstractExtendedCsdlElement<CsdlFunctionImport, ExtendedCsdlFunctionImportRefactored> implements ExtendedCsdlElement {

    /**
     * 构造函数
     */
    public ExtendedCsdlFunctionImportRefactored() {
     ...
     */
    public static ExtendedCsdlFunctionImportRefactored fromCsdlFunctionImport(CsdlFunctionImport source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlFunctionImportRefactored extended = new ExtendedCsdlFunctionImportRefactored();
    ...
    public ExtendedCsdlFunctionImportRefactored setName(String name) {
    ...
    public ExtendedCsdlFunctionImportRefactored setFunction(String function) {
        wrappedElement.setFunction(function);
        return this;
    }

    public ExtendedCsdlFunctionImportRefactored setFunction(FullQualifiedName functionFQN) {
    ...
    public ExtendedCsdlFunctionImportRefactored setEntitySet(String entitySet) {
    ...
    public ExtendedCsdlFunctionImportRefactored setIncludeInServiceDocument(boolean includeInServiceDocument) {
    ...
    public String toString() {
        return "ExtendedCsdlFunctionImportRefactored{" +
                "name='" + getName() + '\'' +
                ", namespace='" + namespace + '\'' +
