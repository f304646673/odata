 ...
 */
public class ExtendedCsdlTypeDefinitionRefactored extends AbstractExtendedCsdlElement<CsdlTypeDefinition, ExtendedCsdlTypeDefinitionRefactored> implements ExtendedCsdlElement {

    /**
     * 构造函数
     */
    public ExtendedCsdlTypeDefinitionRefactored() {
     ...
     */
    public static ExtendedCsdlTypeDefinitionRefactored fromCsdlTypeDefinition(CsdlTypeDefinition source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlTypeDefinitionRefactored extended = new ExtendedCsdlTypeDefinitionRefactored();
    ...
    public ExtendedCsdlTypeDefinitionRefactored setName(String name) {
    ...
    public ExtendedCsdlTypeDefinitionRefactored setUnderlyingType(String underlyingType) {
    ...
    public ExtendedCsdlTypeDefinitionRefactored setMaxLength(Integer maxLength) {
    ...
    public ExtendedCsdlTypeDefinitionRefactored setPrecision(Integer precision) {
    ...
    public ExtendedCsdlTypeDefinitionRefactored setScale(Integer scale) {
    ...
    public ExtendedCsdlTypeDefinitionRefactored setUnicode(Boolean unicode) {
    ...
    public ExtendedCsdlTypeDefinitionRefactored setSrid(SRID srid) {
    ...
    public String toString() {
        return "ExtendedCsdlTypeDefinitionRefactored{" +
                "name='" + getName() + '\'' +
                ", namespace='" + namespace + '\'' +
