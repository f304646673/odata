 ...
 */
public class ExtendedCsdlParameterRefactored extends AbstractExtendedCsdlElement<CsdlParameter, ExtendedCsdlParameterRefactored> implements ExtendedCsdlElement {
     ...
     * 构造函数
     */
    public ExtendedCsdlParameterRefactored() {
     ...
     */
    public static ExtendedCsdlParameterRefactored fromCsdlParameter(CsdlParameter source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlParameterRefactored extended = new ExtendedCsdlParameterRefactored();
    ...
    public ExtendedCsdlParameterRefactored setName(String name) {
    ...
    public ExtendedCsdlParameterRefactored setType(String type) {
        wrappedElement.setType(type);
        return this;
    }

    public ExtendedCsdlParameterRefactored setType(FullQualifiedName type) {
        wrappedElement.setType(type);
        return this;
    }
    ...
    public ExtendedCsdlParameterRefactored setCollection(boolean isCollection) {
    ...
    public ExtendedCsdlParameterRefactored setNullable(Boolean nullable) {
    ...
    public ExtendedCsdlParameterRefactored setMaxLength(Integer maxLength) {
    ...
    public ExtendedCsdlParameterRefactored setPrecision(Integer precision) {
    ...
    public ExtendedCsdlParameterRefactored setScale(Integer scale) {
    ...
    public ExtendedCsdlParameterRefactored setSrid(SRID srid) {
    ...
    public ExtendedCsdlParameterRefactored setParentName(String parentName) {
    ...
    public String toString() {
        return "ExtendedCsdlParameterRefactored{" +
                "name='" + getName() + '\'' +
                ", namespace='" + namespace + '\'' +
                ", type='" + getType() + '\'' +
