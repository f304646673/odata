 ...
 */
public class ExtendedCsdlEntityContainerRefactored extends AbstractExtendedCsdlElement<CsdlEntityContainer, ExtendedCsdlEntityContainerRefactored> implements ExtendedCsdlElement {
     ...
     * 构造函数
     */
    public ExtendedCsdlEntityContainerRefactored() {
     ...
     */
    public static ExtendedCsdlEntityContainerRefactored fromCsdlEntityContainer(CsdlEntityContainer source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlEntityContainerRefactored extended = new ExtendedCsdlEntityContainerRefactored();
    ...
    public ExtendedCsdlEntityContainerRefactored setName(String name) {
    ...
    public ExtendedCsdlEntityContainerRefactored setExtends(String extendsContainer) {
        ((CsdlEntityContainer) wrappedElement).setExtends(extendsContainer);
        return this;
    }

    public ExtendedCsdlEntityContainerRefactored setExtends(FullQualifiedName extendsFQN) {
    ...
    */
    ...
    public ExtendedCsdlEntityContainerRefactored setEntitySets(List<CsdlEntitySet> entitySets) {
    ...
    public ExtendedCsdlEntityContainerRefactored setSingletons(List<CsdlSingleton> singletons) {
    ...
    public ExtendedCsdlEntityContainerRefactored setActionImports(List<CsdlActionImport> actionImports) {
    ...
    public ExtendedCsdlEntityContainerRefactored setFunctionImports(List<CsdlFunctionImport> functionImports) {
    ...
    public ExtendedCsdlEntityContainerRefactored addExtendedEntitySet(ExtendedCsdlEntitySet entitySet) {
        if (entitySet != null) {
    ...
    public ExtendedCsdlEntityContainerRefactored addExtendedActionImport(ExtendedCsdlActionImport actionImport) {
    ...
    public ExtendedCsdlEntityContainerRefactored addExtendedFunctionImport(ExtendedCsdlFunctionImport functionImport) {
    ...
    // 简化实现的方法
    public ExtendedCsdlEntityContainerRefactored addExtendedSingleton(ExtendedCsdlSingleton singleton) {
        if (singleton != null) {
    ...
    public String toString() {
        return "ExtendedCsdlEntityContainerRefactored{" +
                "name='" + getName() + '\'' +
                ", namespace='" + namespace + '\'' +
