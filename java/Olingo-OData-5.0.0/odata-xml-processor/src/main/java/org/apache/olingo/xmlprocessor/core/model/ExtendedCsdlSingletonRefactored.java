 ...
 */
public class ExtendedCsdlSingletonRefactored extends AbstractExtendedCsdlElement<CsdlSingleton, ExtendedCsdlSingletonRefactored> implements ExtendedCsdlElement {
     ...
     * 构造函数
     */
    public ExtendedCsdlSingletonRefactored() {
     ...
     */
    public static ExtendedCsdlSingletonRefactored fromCsdlSingleton(CsdlSingleton source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlSingletonRefactored extended = new ExtendedCsdlSingletonRefactored();
    ...
    public ExtendedCsdlSingletonRefactored setName(String name) {
    ...
    public ExtendedCsdlSingletonRefactored setType(String type) {
    ...
    public ExtendedCsdlSingletonRefactored setNavigationPropertyBindings(List<CsdlNavigationPropertyBinding> bindings) {
    ...
    public ExtendedCsdlSingletonRefactored addExtendedNavigationPropertyBinding(ExtendedCsdlNavigationPropertyBinding binding) {
        if (binding != null) {
    ...
    public String toString() {
        return "ExtendedCsdlSingletonRefactored{" +
                "name='" + getName() + '\'' +
                ", namespace='" + namespace + '\'' +
                ", type='" + getType() + '\'' +
