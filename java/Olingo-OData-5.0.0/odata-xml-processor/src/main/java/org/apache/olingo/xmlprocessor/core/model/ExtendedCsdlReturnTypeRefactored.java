 ...
 */
public class ExtendedCsdlReturnTypeRefactored extends AbstractExtendedCsdlElement<CsdlReturnType, ExtendedCsdlReturnTypeRefactored> implements ExtendedCsdlElement {
     ...
     * 构造函数
     */
    public ExtendedCsdlReturnTypeRefactored() {
     ...
     */
    public static ExtendedCsdlReturnTypeRefactored fromCsdlReturnType(CsdlReturnType source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlReturnTypeRefactored extended = new ExtendedCsdlReturnTypeRefactored();
    ...
    public ExtendedCsdlReturnTypeRefactored setType(String type) {
        wrappedElement.setType(type);
        return this;
    }

    public ExtendedCsdlReturnTypeRefactored setType(FullQualifiedName type) {
        wrappedElement.setType(type);
        return this;
    }
    ...
    public ExtendedCsdlReturnTypeRefactored setCollection(boolean isCollection) {
    ...
    public ExtendedCsdlReturnTypeRefactored setNullable(Boolean nullable) {
    ...
    public ExtendedCsdlReturnTypeRefactored setMaxLength(Integer maxLength) {
    ...
    public ExtendedCsdlReturnTypeRefactored setPrecision(Integer precision) {
    ...
    public ExtendedCsdlReturnTypeRefactored setScale(Integer scale) {
    ...
    public ExtendedCsdlReturnTypeRefactored setSrid(SRID srid) {
    ...
    public ExtendedCsdlReturnTypeRefactored setParentName(String parentName) {
    ...
    public String toString() {
        return "ExtendedCsdlReturnTypeRefactored{" +
                "namespace='" + namespace + '\'' +
                ", type='" + getType() + '\'' +
