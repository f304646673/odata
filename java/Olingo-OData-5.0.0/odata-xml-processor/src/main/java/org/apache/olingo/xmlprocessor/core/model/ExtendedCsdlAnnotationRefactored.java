 ...
 */
public class ExtendedCsdlAnnotationRefactored extends AbstractExtendedCsdlElement<CsdlAnnotation, ExtendedCsdlAnnotationRefactored> implements ExtendedCsdlElement {

    /**
     * 构造函数
     */
    public ExtendedCsdlAnnotationRefactored() {
     ...
     */
    public static ExtendedCsdlAnnotationRefactored fromCsdlAnnotation(CsdlAnnotation source) {
        if (source == null) {
            return null;
        }

        ExtendedCsdlAnnotationRefactored extended = new ExtendedCsdlAnnotationRefactored();
    ...
    public ExtendedCsdlAnnotationRefactored setTerm(FullQualifiedName term) {
        wrappedElement.setTerm(term.getFullQualifiedNameAsString());
        return this;
    }

    public ExtendedCsdlAnnotationRefactored setTerm(String term) {
    ...
    public ExtendedCsdlAnnotationRefactored setQualifier(String qualifier) {
    ...
    public ExtendedCsdlAnnotationRefactored setExpression(CsdlExpression expression) {
    ...
    public String toString() {
        return "ExtendedCsdlAnnotationRefactored{" +
                "term='" + getTerm() + '\'' +
